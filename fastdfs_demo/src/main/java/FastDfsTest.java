...
//        1、加载配置文件，配置文件中的内容就是 tracker 服务的地址。ClientGlobal加载
        ClientGlobal.init("C:\\MyWorkspace\\IdeaProjects\\suodao1\\workspace\\fastdfs_demo\\src\\main\\resources\\fdfs_client.conf");
...
//        6、使用 StorageClient 对象上传图片
        String[] jpgs = storageClient.upload_file("D:\\2.jpg", "jpg", null);
//        7、返回数组。包含组名和图片的路径
        for (String jpg : jpgs) {
